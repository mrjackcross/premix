...
var WaveSurfer = {
    ...
    play: function (playTime, start, end) {

        this.backend.play(playTime, start, end);

        this._startAnimationDelayed(playTime, this);

    },

    // Custom function to delay the start of the animation
    _startAnimationDelayed: function (playTime, self) {
        requestAnimationFrame(function () {

            if(self.getCurrentTime() >= playTime) {

                self.startAnimationLoop();

            } else {
                self._startAnimationDelayed(playTime, self);
            }
